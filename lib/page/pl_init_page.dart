...
class PlInitPage extends StatelessWidget {
  const PlInitPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    DataController _controller = Get.find<DataController>();
    final _formKey = GlobalKey<FormState>();
    final color = ColorPalettes.pl;
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: CustomText(
                          text:
                              "Data di atas adalah milik saya sendiri. Saya juga menyetujui Syarat dan Ketentuan serta Kebijakan Privasi PeduliLindungi.",
                          fontSize: 12.sp,
